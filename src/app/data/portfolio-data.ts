...
export const portfolioData = {
  ...
  skills: {
    ...
    aiTools: [
      { name: "ChatGPT", level: 95, icon: "🤖" },
      { name: "Claude AI", level: 90, icon: "🧠" },
      { name: "GitHub Copilot", level: 85, icon: "✈️" },
      { name: "Figma AI", level: 80, icon: "✨" },
      { name: "Antigravity AI", level: 95, icon: "🚀" },
    ]
  },
  ...
  projects: [
    {
      ...
      description: "A comprehensive full stack e-learning platform where students can access coding courses, track progress, and submit projects. Features include user authentication, course management dashboard, and an interactive code learning module.",
    ...
    },
    {
      ...
      description: "A modern, industry-level developer portfolio website showcasing projects, skills, and experience with premium glassmorphism UI, smooth animations and fully responsive mobile-first design.",
    ...
    },
    {
      ...
      category: "E-Commerce",
      description: "A responsive Book Store web application featuring book listings, clean UI, category-based presentation, and smooth front-end interactions with a solid responsive layout.",
